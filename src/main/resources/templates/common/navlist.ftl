<div class="col-md-12 green" >
	...
	<ul class="nav navbar-nav navbar-right moredeep">
		...
		<li>
			<a href="javascript:changepath('/mail');" class="green-none white">
		...
		<li>
			<a href="javascript:changepath('/mytask');" class="green-none white">
		...
		<!--设置导航栏头像面板--> 
			<a href="#" class="green-none white" data-toggle="dropdown">
					<img src="images/user/${(user.imgPath)!'/timg.jpg'}" class="user-image" /> <span>${user.realName}</span>
			</a>
			<!--设置点击按钮弹出用户面板层-->
			<ul class="dropdown-menu" style="padding:0;">
				<li class="user-header green"><img src="images/user/${(user.imgPath)!'/timg.jpg'}"
					...
					<p class="white" style="">
						...
						<span> 部门</span> / <span> 角色</span><br> <small>职位</small>
					</p>
				</li>
